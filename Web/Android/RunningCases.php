...
$sql = "SELECT scheduling_time, case_id, EmailJR FROM Case_Scheduling where EmailJR='$EmailJR' and case_id in (SELECT case_id FROM Form_FIR WHERE case_status='RUNNING_CASE')";
