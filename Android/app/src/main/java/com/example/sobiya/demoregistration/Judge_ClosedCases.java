...
public class Judge_ClosedCases extends AppCompatActivity {

    private Session session;

    private static final String CLOSED_URL = URLPath.Path+"ClosedCases.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_judge__closed_cases);

        session = new Session(Judge_ClosedCases.this);

        getCases(CLOSED_URL);

    }

    private void getCases(String url) {
        class GetJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Judge_ClosedCases.this, "Please Wait...", null, true, true);
            }
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length() ; i++) {
                        ...
                        TableRow tr = new TableRow(Judge_ClosedCases.this);
                        ...
                        TextView tv0 = new TextView(Judge_ClosedCases.this);
                        tv0.setText(case_id);
                        tv0.setPadding(20, 0, 0, 0);
                        tr.addView(tv0);


                        Button tv2 = new Button(Judge_ClosedCases.this);
                        tv2.setText("VIEW");
                        tv2.setPadding(20, 0, 0, 0);
                        tr.addView(tv2);

                        Button caseHistory = new Button(Judge_ClosedCases.this);
